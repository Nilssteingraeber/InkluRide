...
<template>
	<div class="container-fluid" style="z-index: 600;"> 
		<div class="row">
			<div class="col-3" id="logo">
				<RouterLink to="/"><img alt="Prepper logo" class="logo" src="@/assets/LogoInkluRide.svg" width="100"
						height="70" /></RouterLink>
			</div>
			<div class="col-6 align-self-center">
				<form class="d-flex">
					<input class="form-control pe-sm-5 m-2" type="search" placeholder="Bergbaumuseum Bochum" aria-label="Search">
					<button class="btn btn-outline-secondary m-2" type="button">Suchen</button>
				</form>
			</div>
			<div class="col-3 align-self-center" id="header-profile" style="text-align: right; height: 100%;">
